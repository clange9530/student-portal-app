                         ...
                         <Grid container direction="column" spacing={16} className="email-grid">
                              ...
                              <Grid item md>
                                   <Table style={{"width": "auto"}}>
                                        <TableBody>
                                             <TableHead>
                                                  <Typography variant="h8">Detailed Info for Team "{this.state.teamName}" </Typography>
                                                  <TableRow>
                                                       <TableCell>Product Manager: {this.state.prod_mgr}</TableCell>
                                                  </TableRow>
                                                  <TableRow>
                                                       <TableCell>Scrum Master: {this.state.scrum_mstr}</TableCell>
                                                  </TableRow>
                                                  <TableRow>
                                                       <TableCell>Primary Contact: {this.state.primary_cont}</TableCell>
                                                  </TableRow>
                                                  <TableRow>
                                                       <TableCell>Team GitHub Repo: {this.state.gitHub_repo}</TableCell>
                                                  </TableRow>
                                             </TableHead>  
                                        </TableBody>   
                                   </Table> 
